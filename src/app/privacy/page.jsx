  ...
  return (
    <div className="bg-background pb-24">
      ...
      <section className="max-w-4xl mx-auto px-6 mt-16 text-dark/70 leading-relaxed text-sm md:text-base flex flex-col gap-8">
        ...
        <div>
          <h2 className="font-heading font-bold text-xl sm:text-2xl text-dark mb-4">1. Data Collection</h2>
          <p>
        ...
        <div>
          <h2 className="font-heading font-bold text-xl sm:text-2xl text-dark mb-4">2. GPS Coordinates Tracking</h2>
          <p>
        ...
        <div>
          <h2 className="font-heading font-bold text-xl sm:text-2xl text-dark mb-4">3. Data Sharing</h2>
          <p>
        ...
        <div>
          <h2 className="font-heading font-bold text-xl sm:text-2xl text-dark mb-4">4. Security Infrastructure</h2>
          <p>
        ...
        <div>
          <h2 className="font-heading font-bold text-xl sm:text-2xl text-dark mb-4">5. Customer Rights</h2>
          <p>
