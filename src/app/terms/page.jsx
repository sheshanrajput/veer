  ...
  return (
    <div className="bg-background pb-24">
      ...
      <section className="max-w-4xl mx-auto px-6 mt-16 text-dark/70 leading-relaxed text-sm md:text-base flex flex-col gap-8">
        ...
        <div>
          <h2 className="font-heading font-bold text-xl sm:text-2xl text-dark mb-4">1. Packing Compliance</h2>
          <p>
        ...
        <div>
          <h2 className="font-heading font-bold text-xl sm:text-2xl text-dark mb-4">2. Customs Clearance & Duties</h2>
          <p>
        ...
        <div>
          <h2 className="font-heading font-bold text-xl sm:text-2xl text-dark mb-4">3. Delivery Timelines</h2>
          <p>
        ...
        <div>
          <h2 className="font-heading font-bold text-xl sm:text-2xl text-dark mb-4">4. Liability & Insurance</h2>
          <p>
